"""
Django settings for super_rain_38592 project.
...
ROOT_URLCONF = 'super_rain_38592.urls'
...
WSGI_APPLICATION = 'super_rain_38592.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_rain_38592 API",
    "DESCRIPTION": "API documentation for super_rain_38592 App",
    "VERSION": "v1",
}
